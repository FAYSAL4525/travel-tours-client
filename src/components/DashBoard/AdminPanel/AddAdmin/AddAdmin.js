...
const AddAdmin = () => {
	...
	const handleAddAdmin = () => {
		...
		const uri = `https://afternoon-savannah-22003.herokuapp.com/addAdmin`;
		fetch(uri, {
			method: 'POST',
			headers: {
	...
	return (
		<div>
			<div className="login-container-admin ">
				<div className="container-margin-admin ">
					<div className="create-account-container-admin bg-light">
						<h2 style={{fontSize:"20px"}}>ADD ADMIN</h2>
