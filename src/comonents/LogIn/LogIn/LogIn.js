				...
				<div className="container-margin">
					<div className="create-account-container">
						...
						<form className="form" onSubmit={handleSubmit}>
							{newUser && <input className="input" type="text" name="name" placeholder="Name" onBlur={inputFieldChange} required />}<br />
							<h6></h6>
							...
							<div className="submit-btn">
								<input className="submit input" type="submit" value={newUser ? "Create a Account" : "LogIn"} />
							</div>
