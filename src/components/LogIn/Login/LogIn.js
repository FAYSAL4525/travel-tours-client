  ...
  const inputFieldChange = (e) => {
    ...
    if (e.target.name === "confrimPassword") {
      ...
      if (valid) {
        ...
        const passworError =
          "password must be 6 character and contain 1 number";
        const userInfo = { ...user };
        userInfo.errorDisMatch = "";
          ...
          <div className="create-account-container">
            ...
            <form className="form" onSubmit={handleSubmit}>
              ...
              <div className="submit-btn">
                <input
                  ...
                  type="submit"
                  value={newUser ? "Create a Account" : "LogIn"}
                />
              </div>
            ...
            {user.success && (
              <small style={{ color: "green" }}>
                {loggedInUser.name} user {newUser ? "created" : "login"}{" "}
                successfully
              </small>
            )}
            ...
            <div className="btn-container">
              <div>
                ...
                <button className="button" onClick={googleSignIn}>
                  ...
                  <i className="icon-text"></i>GOOGLE
                </button>
              </div>
              <div>
                <button className="button" onClick="">
                  <i className="fab fa-github-square fa-2x"></i>
                  <i className="icon-text"></i>GITHUB
                </button>
              </div>
            </div>
          </div>
